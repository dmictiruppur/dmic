...
class AadharImageUploadScreen extends StatefulWidget {
  const AadharImageUploadScreen({Key key}) : super(key: key);
...
class _ProfileImageUploadScreenState extends State<AadharImageUploadScreen> {
